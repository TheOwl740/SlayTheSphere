...
function updateTutorial() {
  ...
  rt.renderText(new Pair(cs.w / 2, (cs.h / -10) - ((landscape ? cs.w / 40 : cs.h / 30) * 1)), new TextNode("Courier New", "Slay The Sphere is a turn based dungeon crawler", 0, landscape ? cs.w / 50 : cs.h / 75, "center"), new Fill("#EEEEFF", 1));
  rt.renderText(new Pair(cs.w / 2, (cs.h / -10) - ((landscape ? cs.w / 40 : cs.h / 30) * 2)), new TextNode("Courier New", "The objective is to destroy each floor's sphere", 0, landscape ? cs.w / 50 : cs.h / 75, "center"), new Fill("#EEEEFF", 1));
  rt.renderText(new Pair(cs.w / 2, (cs.h / -10) - ((landscape ? cs.w / 40 : cs.h / 30) * 3)), new TextNode("Courier New", "Move by clicking floor tiles, (light colored)", 0, landscape ? cs.w / 50 : cs.h / 75, "center"), new Fill("#EEEEFF", 1));
  rt.renderText(new Pair(cs.w / 2, (cs.h / -10) - ((landscape ? cs.w / 40 : cs.h / 30) * 4)), new TextNode("Courier New", "You will encounter enemies (red cubes and more)", 0, landscape ? cs.w / 50 : cs.h / 75, "center"), new Fill("#EEEEFF", 1));
  rt.renderText(new Pair(cs.w / 2, (cs.h / -10) - ((landscape ? cs.w / 40 : cs.h / 30) * 5)), new TextNode("Courier New", "Click them to attack. They will emit damage numbers", 0, landscape ? cs.w / 50 : cs.h / 75, "center"), new Fill("#EEEEFF", 1));
  rt.renderText(new Pair(cs.w / 2, (cs.h / -10) - ((landscape ? cs.w / 40 : cs.h / 30) * 6)), new TextNode("Courier New", "Watch your healthbar (top left)- no respawns", 0, landscape ? cs.w / 50 : cs.h / 75, "center"), new Fill("#EEEEFF", 1));
  rt.renderText(new Pair(cs.w / 2, (cs.h / -10) - ((landscape ? cs.w / 40 : cs.h / 30) * 7)), new TextNode("Courier New", "Killing enemies awards xp- 20 xp for a skill point", 0, landscape ? cs.w / 50 : cs.h / 75, "center"), new Fill("#EEEEFF", 1));
  rt.renderText(new Pair(cs.w / 2, (cs.h / -10) - ((landscape ? cs.w / 40 : cs.h / 30) * 8)), new TextNode("Courier New", "Destroy the sphere to advance to next level", 0, landscape ? cs.w / 50 : cs.h / 75, "center"), new Fill("#EEEEFF", 1));
  rt.renderText(new Pair(cs.w / 2, (cs.h / -10) - ((landscape ? cs.w / 40 : cs.h / 30) * 9)), new TextNode("Courier New", "The dungeon's dark- shaded tiles are out of view", 0, landscape ? cs.w / 50 : cs.h / 75, "center"), new Fill("#EEEEFF", 1));
